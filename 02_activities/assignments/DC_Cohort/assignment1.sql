...
CASE
	...
	--WHEN product_name LIKE '%pepper%' THEN 1 --no difference?
	ELSE 0
END AS pepper_flag
FROM product;
--END QUERY
...
INNER JOIN vendor AS v
	...
	--USING (vendor_id) --if avoid the vendor_id duplicate
...
GROUP BY c.customer_id, c.customer_first_name, c.customer_last_name, c.customer_postal_code
--GROUP BY c.customer_id --seems no difference?
...
*/
--QUERY 10
--DROP TABLE IF EXISTS temp.new_vendor; --for practice
